    ...
    <div style={{ color: 'white' }}>
      <div className={classes.technologyContainer}>
        ...
        <div className={classes.techButtons}>
          {technology_info.map((tech, index) => {
            return (
              <button
                key={tech.name}
                className={`${classes.btn} font-bellefair-preset-4 ${
                  currentTech === tech.name ? classes.active : ''
                }`}
        ...
        <div className={classes.descriptionContainer}>
          <p style={{ color: '#ffffff40' }} className="font-bellefair-preset-4">
            THE TERMINOLOGY...
          </p>
          <p className={`${classes.technologyName} font-bellefair-preset-3`}>
            {tech.name}
          </p>
          <p
            className={`${classes.technologyDescription} font-barlow-preset-9`}
          >
            {tech.description}
          </p>
        </div>
